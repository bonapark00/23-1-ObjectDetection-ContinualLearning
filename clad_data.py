...
from clad_meta import CLADD_TRAIN_VAL_DOMAINS, CLADD_TEST_DOMAINS, SODA_ROOT
from clad_utils import *
...
def main():
    train_, val_ = get_clad_trainval(root=SODA_ROOT)
    data = get_clad_datalist()
    breakpoint()

...
def incremental_parser():
    ...
    parser.add_argument("--ckpt_epoch", type=int, default=10, help="Checkpoint epoch")
    parser.add_argument("--ckpt", type=str, default="./model_checkpoints", help="Checkpoint path")
    parser.add_argument("--note", default="", type=str, help="Short description of the exp")
    parser.add_argument(
        "--memory_size", type=int, default=150, help="Episodic memory size"
    )

...
from .backbone import resnet_fpn_backbone, _validate_trainable_layers
...
__all__ = [
    "FastRCNN", "fasterrcnn_resnet50_fpn"
]


class FastRCNN(GeneralizedRCNN):
    """
    Implements Fast R-CNN.
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(FastRCNN, self).__init__(backbone, roi_heads, transform)
...
def fastrcnn_resnet50_fpn(pretrained=False, progress=True,
    ...
    model = FastRCNN(backbone, num_classes, **kwargs)
    if pretrained:

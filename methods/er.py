...
import numpy as np
import torch
from utils.train_utils import select_model, select_memory, select_stream
...
class ER:
    def __init__(self, criterion, device, train_transform, test_transform, n_classes, writer, **kwargs):
        ...
        logger.info("ER initializer called")
        ...
        self.task_num = 0
        logger.info("ER initializer finished")
    ...
    def online_train(self, sample, batch_size, n_worker, iterations=1, stream_batch_size=1):
        ...
        for i in range(iterations):
            ...
            # Get memory data from memory dataset

...
CUDA_VISIBLE_DEVICES=4 ./scripts/${METHOD_NAME}.sh 1 > logs/clad_${METHOD_NAME}_${MEMORY_SIZE}_1${NOTE_SUFFIX}.txt 2>&1 &
CUDA_VISIBLE_DEVICES=6 ./scripts/${METHOD_NAME}.sh 2 > logs/clad_${METHOD_NAME}_${MEMORY_SIZE}_2${NOTE_SUFFIX}.txt 2>&1 &
CUDA_VISIBLE_DEVICES=7 ./scripts/${METHOD_NAME}.sh 3 > logs/clad_${METHOD_NAME}_${MEMORY_SIZE}_3${NOTE_SUFFIX}.txt 2>&1 &

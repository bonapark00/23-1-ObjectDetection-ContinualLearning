...
#   - Set logs/{method_name}
# 3. Comment out the line belows to modify seed values
# 4. Run this file

METHOD_NAME="rodeo"
MEMORY_SIZE=13928
NOTE="default_13928" # You can write NOTE here
...
CUDA_VISIBLE_DEVICES=0 ./scripts/${METHOD_NAME}.sh 3 > logs/clad_${METHOD_NAME}_${MEMORY_SIZE}_3${NOTE_SUFFIX}.txt 2>&1 &
